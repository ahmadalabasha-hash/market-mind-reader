...
import { SESSION_COOKIE_NAME, getUserTier, hasProAccess, hasUltimateAccess } from "@/lib/auth-types";
...
export default async function ProPage() {
  ...
  // Access control: Check if user has Pro access
  if (!hasProAccess(userTier, isSuperAdmin)) {
    redirect("/pricing");
  }
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-zinc-400">
                  Market indices signals plus all stocks with expected range analysis
                </p>
